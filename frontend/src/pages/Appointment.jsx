...
const Appointment = () => {
    ...
    const getAvailableSolts = async () => {
        ...
        // Reference date is the user-selected date
        const today = new Date()
        const baseDate = new Date(selectedDate)

        // Start at first available slot time for that day
        ...
        while (currentDate < endTime) {
            ...
            const st = formattedTime

            const booked = (docInfo.slots_booked && docInfo.slots_booked[slotDate]) ? docInfo.slots_booked[slotDate] : []
            const isSlotAvailable = booked.includes(st) ? false : true
        ...
        <div>
            ...
            <div className='sm:ml-72 sm:pl-4 mt-8 font-medium text-[#565656]'>
                ...
                <div className='flex items-center gap-3 mt-4'>
                    ...
                    <input
                        type='date'
                        className='border border-[#DDDDDD] rounded-md px-3 py-2 text-sm'
                        value={(() => {
